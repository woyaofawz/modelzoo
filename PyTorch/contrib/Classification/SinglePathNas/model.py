...
class SinglePath_OneShot(nn.Module):
    def __init__(self, dataset='imagenet', resize=False, classes=1000, layers=20):
...
class SinglePath_Network(nn.Module):
    def __init__(self, dataset='imagenet', resize=False, classes=1000, layers=20,choice=np.random.randint(4, size=20)):

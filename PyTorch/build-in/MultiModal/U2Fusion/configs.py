...
def set_args():
    ...
    # 数据集相关参数
    parser.add_argument('--image_path', default=r'/mnt/nvme1/application/hongzg/dataset/RoadScene-master', type=str, help='数据集路径')
    parser.add_argument('--train_num', default=118287, type=int, help='用于训练的图像数量')
    # 训练相关参数

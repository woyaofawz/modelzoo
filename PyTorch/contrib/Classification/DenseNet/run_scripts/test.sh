...
python run_DenseNet.py --data_path /data/teco-data/imagenet --batch_size 64 --epochs 1 --lr 0.1 --save_path ./checkpoints --num_steps 100 --growthRate 12 --dropRate 0.2 --reduction 0.5 --bottleneck --depth 121 --dataset imagenet --optMemory 2 --cudnn deterministic | tee sdaa.log
